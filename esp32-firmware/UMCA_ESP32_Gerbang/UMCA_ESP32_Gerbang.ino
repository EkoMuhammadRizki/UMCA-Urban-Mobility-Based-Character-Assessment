...
const char* DEVICE_SECRET = "umca-secret-key-gerbang-001";
const char* DEFAULT_MODA_TRANSPORT = "Mobil Pribadi"; // Otomatis kategori Potensi Tinggi Emisi
const char* AP_NAME = "UMCA-Gerbang-Setup";
...
void loop() {
  ...
  Serial.println();
  Serial.println("---------------------------------------------");
  Serial.print("[GERBANG] KARTU TERDETEKSI! UID: ");
